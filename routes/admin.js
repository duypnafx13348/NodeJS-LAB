...
router.get('/add-product',(req, res, next) => {
    res.sendFile(path.join(__dirname, '../', 'views', 'add-product.html')) // sử dụng sendFile(path.join(__dirname, '../', 'views', 'add-product.html')) để lấy file add-product.html từ views
});
